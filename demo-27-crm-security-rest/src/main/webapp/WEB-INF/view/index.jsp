...
<s:authorize access="!isAuthenticated()">
	...
	<section class="main-body row">
		...
		<h2 class="text-center p-0 m-0 col-10 col-md-8 mt-4 ">Welcome to Frobese CRM - demo System!</h2>
...
<s:authorize access="isAuthenticated()">
	...
	<section class="main-body row container mx-auto">
			...
			<h2 class="text-center p-0 m-0 col-12 mt-5 ">Frobese CRM - demo System!</h2>
					...
					<s:authorize access="hasRole('ADMIN') ">
						<div class="card p-1 my-3 mx-2 border-0 shadow" style="width: 14rem;height: 14rem;background-color: #e9edc9">
						  <div class="card-body mt-2">
						    ...
						    <a href="${pageContext.request.contextPath}/register" class="stretched-link"></a>
						  </div>
						</div>
					</s:authorize>
					...
					<s:authorize access="hasAnyRole('MANAGER', 'ADMIN')">
						<div class="card p-1 my-3 mx-2 border-0 shadow" style="width: 14rem;height: 14rem;background-color: #e9edc9">
						  <div class="card-body mt-2">
						    ...
						    <a href="${pageContext.request.contextPath}/customer/showFormForAdd" class="stretched-link"></a>
						  </div>
						</div>
					</s:authorize>
